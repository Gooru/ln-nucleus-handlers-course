...
public class AJEntityCollection extends Model {
  ...
  public static final String SELECT_COLLECTION_SUMMARY = "SELECT id, title, format, sequence_id FROM collection WHERE lesson_id = ?::uuid AND unit_id = ?::uuid AND course_id = ?::uuid AND is_deleted = ? order by sequence_id asc";
