  ...
  public ExecutionResult<MessageResponse> checkSanity() {
    ...
    if (subjectBucket == null || subjectBucket.isEmpty()) {
      ...
      return new ExecutionResult<>(
          MessageResponseFactory.createInvalidRequestResponse("missing subject bucket"),
          ExecutionStatus.FAILED);
    }
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    try {
      List coursesToReorder =
          Base.firstColumn(AJEntityCourse.SELECT_COURSE_TO_REORDER, context.userId(),
              subjectBucket);
    ...
    return new ExecutionResult<>(MessageResponseFactory.createNoContentResponse(
        EventBuilderFactory.getReorderCourseEventBuilder(subjectBucket)),
