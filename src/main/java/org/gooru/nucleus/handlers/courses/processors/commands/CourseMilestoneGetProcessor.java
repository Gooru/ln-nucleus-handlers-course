...
class CourseMilestoneGetProcessor extends AbstractCommandProcessor {

  private static final Logger LOGGER = LoggerFactory.getLogger(CourseMilestoneGetProcessor.class);

  CourseMilestoneGetProcessor(ProcessorContext context) {
    super(context);
  }
  ...
  protected MessageResponse processCommand() {
    ...
    LOGGER
        .info("Getting milestone '{}' for course '{}'", context.milestoneId(), context.courseId());
    return new RepoBuilder().buildMilestoneRepo(context).fetchMilestone();
