...
public class UpdateCourseHandler implements DBHandler {
    ...
    if (context.request() == null || context.request().isEmpty()) {
      ...
      return new ExecutionResult<>(
          MessageResponseFactory
              .createInvalidRequestResponse("Invalid data provided to update course"),
          ExecutionStatus.FAILED);
    }
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    ...
    int sequenceId = 1;
    Object objSubjectBucket = Base
        .firstCell(AJEntityCourse.SELECT_SUBJECT_BUCKET, context.courseId());
    ...
    if (subjectBucketFromPaylaod != null && !subjectBucketFromPaylaod.isEmpty()) {
      if (objSubjectBucket != null) {
        ...
        maxSequenceId = Base
            .firstCell(AJEntityCourse.SELECT_MAX_SEQUENCE_FOR_SUBJECT_BUCKET, context.userId(),
