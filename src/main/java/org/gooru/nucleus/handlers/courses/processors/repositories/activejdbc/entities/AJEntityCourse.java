...
public class AJEntityCourse extends Model {
  ...
  public static final List<String> ALL_FIELDS = Arrays.asList(ID, TITLE, CREATOR_ID, ORIGINAL_CREATOR_ID, MODIFIER_ID, ORIGINAL_COURSE_ID,
  ...
  public static final String SELECT_COURSE_TO_VALIDATE = "SELECT is_deleted, creator_id, publish_date FROM course WHERE id = ?";
  public static final String SELECT_COURSE =
          "SELECT id, title, created_at, updated_at, creator_id, original_creator_id, original_course_id, publish_date, thumbnail, audience,"
