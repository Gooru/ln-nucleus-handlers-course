...
public class AJEntityCourse extends Model {
  ...
  public static final String[] ALL_FIELDS = { ID, TITLE, CREATOR_ID, ORIGINAL_CREATOR_ID, MODIFIER_ID, ORIGINAL_COURSE_ID, PUBLISH_DATE, THUMBNAIL,
      AUDIENCE, METADATA, TAXONOMY, COLLABORATOR, CLASS_LIST, VISIBLE_ON_PROFILE, CREATED_AT, UPDATED_AT };

  public static final String[] UNIT_SUMMARY_FIELDS = { AJEntityUnit.UNIT_ID, AJEntityUnit.TITLE, AJEntityUnit.SEQUENCE_ID };
