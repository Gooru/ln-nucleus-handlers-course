...
class MessageProcessor implements Processor {
  ...
  public MessageResponse process() {
    try {
      ...
      return MessageResponseFactory
          .createInternalErrorResponse("Something wrong in database transaction");
    }
  }
  ...
  private ProcessorContext createContext() {
    ...
    return new ProcessorContext(userId, session, request, courseId, unitId, lessonId, collectionId,
        headers);
  }
