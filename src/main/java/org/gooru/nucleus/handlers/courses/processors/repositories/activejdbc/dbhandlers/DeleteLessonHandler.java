...
public class DeleteLessonHandler implements DBHandler {
    ...
    public ExecutionResult<MessageResponse> checkSanity() {
        if (context.courseId() == null || context.courseId().isEmpty()) {
            ...
            return new ExecutionResult<>(
                MessageResponseFactory.createInvalidRequestResponse("Invalid course id provided to delete lesson"),
        ...
        if (context.unitId() == null || context.unitId().isEmpty()) {
            ...
            return new ExecutionResult<>(
                MessageResponseFactory.createInvalidRequestResponse("Invalid unit id provided to delete lesson"),
                ExecutionStatus.FAILED);
        }
        ...
        if (context.lessonId() == null || context.lessonId().isEmpty()) {
            ...
            return new ExecutionResult<>(
                MessageResponseFactory.createInvalidRequestResponse("Invalid lesson id provided to delete lesson"),
                ExecutionStatus.FAILED);
        }
    ...
    public ExecutionResult<MessageResponse> executeRequest() {
        ...
        if (lessonToDelete.save()) {
            ...
            AJEntityCollection.update("is_deleted = ?, modifier_id = ?::uuid", "lesson_id = ?::uuid", true,
                context.userId(), context.lessonId());
            AJEntityContent.update("is_deleted = ?, modifier_id = ?::uuid", "lesson_id = ?::uuid", true,
                context.userId(), context.lessonId());
