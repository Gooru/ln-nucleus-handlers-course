...
public class DeleteCourseHandler implements DBHandler {
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    ...
    if (courseToDelete.save()) {
      ...
      AJEntityUnit.update("is_deleted = ?, modifier_id = ?::uuid", "course_id = ?::uuid", true,
          context.userId(),
          context.courseId());
      AJEntityLesson.update("is_deleted = ?, modifier_id = ?::uuid", "course_id = ?::uuid", true,
          context.userId(), context.courseId());
      AJEntityCollection
          .update("is_deleted = ?, modifier_id = ?::uuid", "course_id = ?::uuid", true,
              context.userId(), context.courseId());
      ...
      AJEntityClass.update("course_id = null, setting = null",
          "course_id = ?::uuid AND is_deleted = ? AND is_archived = ? AND gooru_version = ?",
          context.courseId(),
  ...
  private JsonObject getModelErrors() {
    ...
    this.courseToDelete.errors().entrySet()
