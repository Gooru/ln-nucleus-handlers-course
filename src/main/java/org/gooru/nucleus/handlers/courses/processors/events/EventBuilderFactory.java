...
public class EventBuilderFactory {
  ...
  public static EventBuilder getCreateCourseEventBuilder(String courseId) {
    return () -> new JsonObject().put(EVENT_NAME, EVT_COURSE_CREATE).put(EVENT_BODY, new JsonObject().put(ID, courseId));
  }
  
  public static EventBuilder getCreateLessonEventBuilder(String lessonId) {
    return () -> new JsonObject().put(EVENT_NAME, EVT_LESSON_CREATE).put(EVENT_BODY, new JsonObject().put(ID, lessonId));
  }

  public static EventBuilder getCreateUnitEventBuilder(String unitId) {
    return () -> new JsonObject().put(EVENT_NAME, EVT_UNIT_CREATE).put(EVENT_BODY, new JsonObject().put(ID, unitId));
  }

  public static EventBuilder getDeleteCourseEventBuilder(String courseId) {
    return () -> new JsonObject().put(EVENT_NAME, EVT_COURSE_DELETE).put(EVENT_BODY, new JsonObject().put(ID, courseId));
  }

  public static EventBuilder getDeleteLessonEventBuilder(String lessonId) {
    return () -> new JsonObject().put(EVENT_NAME, EVT_LESSON_DELETE).put(EVENT_BODY, new JsonObject().put(ID, lessonId));
  }

  public static EventBuilder getDeleteUnitEventBuilder(String unitId) {
    return () -> new JsonObject().put(EVENT_NAME, EVT_UNIT_DELETE).put(EVENT_BODY, new JsonObject().put(ID, unitId));
  }

  public static EventBuilder getMoveCollectionEventBuilder(String lessonId) {
    return () -> new JsonObject().put(EVENT_NAME, EVT_COLLECTION_MOVE).put(EVENT_BODY, new JsonObject().put(ID, lessonId));
  }

  public static EventBuilder getMoveLessonEventBuilder(String unitId) {
    return () -> new JsonObject().put(EVENT_NAME, EVT_LESSON_MOVE).put(EVENT_BODY, new JsonObject().put(ID, unitId));
  }

  public static EventBuilder getMoveUnitEventBuilder(String courseId) {
    return () -> new JsonObject().put(EVENT_NAME, EVT_UNIT_MOVE).put(EVENT_BODY, new JsonObject().put(ID, courseId));
  }

  public static EventBuilder getReorderCollectionEventBuilder(String lessonId) {
    return () -> new JsonObject().put(EVENT_NAME, EVT_LESSON_CONTENT_REORDER).put(EVENT_BODY, new JsonObject().put(ID, lessonId));
  }

  public static EventBuilder getReorderLessonEventBuilder(String unitId) {
    return () -> new JsonObject().put(EVENT_NAME, EVT_UNIT_CONTENT_REORDER).put(EVENT_BODY, new JsonObject().put(ID, unitId));
  }

  public static EventBuilder getReorderUnitEventBuilder(String courseId) {
    return () -> new JsonObject().put(EVENT_NAME, EVT_COURSE_CONTENT_REORDER).put(EVENT_BODY, new JsonObject().put(ID, courseId));
  }
  
  public static EventBuilder getReorderCourseEventBuilder(String subjectBucket) {
    return () -> new JsonObject().put(EVENT_NAME, EVT_COURSE_REORDER).put(EVENT_BODY, new JsonObject().put(SUBJECT_BUCKET, subjectBucket));
  }
  ...
  public static EventBuilder getUpdateLessonEventBuilder(String lessonId) {
    return () -> new JsonObject().put(EVENT_NAME, EVT_LESSON_UPDATE).put(EVENT_BODY, new JsonObject().put(ID, lessonId));
  }

  public static EventBuilder getUpdateUnitEventBuilder(String unitId) {
    return () -> new JsonObject().put(EVENT_NAME, EVT_UNIT_UPDATE).put(EVENT_BODY, new JsonObject().put(ID, unitId));
  }
}
