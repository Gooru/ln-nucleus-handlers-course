...
public class RemoveCollectionFromLessonHandler implements DBHandler {
	...
	public ExecutionResult<MessageResponse> validateRequest() {
		LazyList<AJEntityCourse> ajEntityCourse = AJEntityCourse.findBySQL(AJEntityCourse.SELECT_COURSE_TO_VALIDATE,
		...
		LazyList<AJEntityCollection> collections = AJEntityCollection.findBySQL(
				AJEntityCollection.SELECT_COLLECTION_TO_VALIDATE, context.collectionId(), context.courseId(),
