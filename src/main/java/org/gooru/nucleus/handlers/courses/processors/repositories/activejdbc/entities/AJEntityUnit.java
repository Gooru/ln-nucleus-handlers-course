...
public class AJEntityUnit extends Model{
  ...
  public static final String[] NOTNULL_FIELDS = { TITLE, BIG_IDEAS, ESSENTIAL_QUESTIONS };
  public static final String[] JSON_FIELDS = { METADATA, TAXONOMY };
  public static final String[] JSON_OBJECT_FIELDS = { METADATA, TAXONOMY };
  public static final String[] ALL_FIELDS = { UNIT_ID, COURSE_ID, TITLE, CREATED_AT, UPDATED_AT, CREATOR_ID, MODIFIER_ID, ORIGINAL_CREATOR_ID,
      ORIGINAL_UNIT_ID, BIG_IDEAS, ESSENTIAL_QUESTIONS, METADATA, TAXONOMY, SEQUENCE_ID, IS_DELETED };
}
