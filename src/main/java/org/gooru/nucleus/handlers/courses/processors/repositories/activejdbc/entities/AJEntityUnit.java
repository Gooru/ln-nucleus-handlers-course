...
public class AJEntityUnit extends Model {
  ...
  public static final List<String> ALL_FIELDS = Arrays
    .asList(UNIT_ID, COURSE_ID, TITLE, CREATED_AT, UPDATED_AT, OWNER_ID, CREATOR_ID, MODIFIER_ID, ORIGINAL_CREATOR_ID, ORIGINAL_UNIT_ID, 
       BIG_IDEAS, ESSENTIAL_QUESTIONS, METADATA, TAXONOMY, SEQUENCE_ID, IS_DELETED);

  public static final List<String> INSERTABLE_FIELDS = Arrays.asList(TITLE, BIG_IDEAS, ESSENTIAL_QUESTIONS, METADATA, TAXONOMY);
